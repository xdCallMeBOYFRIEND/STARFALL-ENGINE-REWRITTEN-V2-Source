...
class ABotSpeaker extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		eyes.frames = FlxAnimateFrames.fromAnimate(Paths.getFolderPath('images/abot/systemEyes', 'weekend1'));
		...
		speaker.frames = FlxAnimateFrames.fromAnimate(Paths.getFolderPath('images/abot/abotSystem', 'weekend1'));
